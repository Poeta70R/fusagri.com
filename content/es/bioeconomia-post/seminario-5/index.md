...
De la misma manera, se hace necesario pasar al proceso de escalamiento de los productos de las investigaciones que se vienen realizando, con grandes esfuerzos, en nuestras universidades, para el beneficio de la sociedad, pero también para el fortalecimiento del Sistema Tecnológico Nacional y de las condiciones de nuestros investigadores. Un ambiente propicio para estos encuentros lo debe proporcionar el estado venezolano generando políticas públicas que estimulen y haga realidad esa convergencia tecnológica, por lo demás mostrada con los trabajos que viene realizando con esa maravilla verde llamada Vetiver y con un importante apoyo de la empresa privad. Es tiempo de comenzar a establecer estándares en la huella hídrica gris de las actividades industriales ubicadas en las cuencas más importantes del país, como por ejemplo en la del Lago de Valencia, donde se ubica el problema ambiental más grave de Venezuela, y para lo cual ya hay opciones probadas y escaladas como las  mostradas en este seminario.
